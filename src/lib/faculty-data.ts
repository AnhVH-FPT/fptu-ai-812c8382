...
export const facultyData: Faculty[] = [
  {
    ...
    title: {
      ...
      en: 'Head of Artificial Intelligence Department',
    },
    email: 'an.nv@fpt.edu.vn',
    image: 'https://images.unsplash.com/photo-1560250097-0b93528c311a?w=400&h=400&fit=crop&crop=face',
    researchAreas: {
      vi: ['Thị giác Máy tính (Computer Vision)', 'Học Sâu (Deep Learning)', 'Xử lý ảnh y tế'],
      en: ['Computer Vision', 'Deep Learning', 'Medical Image Processing'],
    },
    courses: {
    ...
    projects: {
      vi: [
        ...
        { name: 'Smart Traffic', desc: 'Ứng dụng Computer Vision phân tích luồng giao thông realtime tại Hà Nội, hợp tác với Sở GTVT.' },
      ...
      en: [
        ...
        { name: 'Smart Traffic', desc: 'Computer Vision application for real-time traffic flow analysis in Hanoi, in collaboration with the Department of Transport.' },
  ...
  },
  {
    ...
    researchAreas: {
      vi: ['Xử lý Ngôn ngữ Tự nhiên (NLP)', 'Mô hình Ngôn ngữ Lớn (LLM)', 'AI trong Giáo dục'],
      en: ['Natural Language Processing (NLP)', 'Large Language Models (LLM)', 'AI in Education'],
    },
    courses: {
  ...
  },
  {
    ...
    researchAreas: {
      vi: ['Học Tăng cường (Reinforcement Learning)', 'Robot Tự hành', 'Hệ thống Multi-Agent'],
      en: ['Reinforcement Learning', 'Autonomous Robotics', 'Multi-Agent Systems'],
    },
    courses: {
